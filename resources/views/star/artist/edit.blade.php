...
@section('content')
    <div class="result_wrap">
        ...
        <input type="hidden" id="url-artist-update" value="{{route('star.artist.update',$artist->id)}}">
        <div class="poster"
             style="background-image: url('{{$artist->picture_url}}')">
...
@endsection
@section('scripts')
    <script src="{{asset('assets/star/js/artist/validate.js')}}" type="text/javascript"></script>
    <script src="{{asset('assets/star/js/artist/create.js')}}"></script>
@endsection